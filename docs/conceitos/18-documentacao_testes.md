...
Para que o código seja considerado pronto para o **Render**, ele deve passar nos 3 testes acima em todos os provedores configurados (**Gemini, Groq, SambaNova, Cerebras**).
