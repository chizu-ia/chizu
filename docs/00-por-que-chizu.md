...
Todo projeto carrega um nome. E todo nome carrega uma história.
...
No avatar do Mestre Chizu, o pergaminho ao fundo traz três caracteres:

**古 早 光**

Que podem ser lidos como *"a luz antiga que desponta cedo"* — uma metáfora zen para a sabedoria que precede as palavras e ilumina antes mesmo de ser buscada.
...
**Na ausência de busca material** — o Chizu é gratuito. Não há anúncios, não há monetização, não há dado coletado para vender. A única intenção é que seja útil.

**No compartilhar** — cada conceito documentado, cada erro registrado, cada decisão explicada é um presente para quem vem depois. O conhecimento que não circula definha.
...
Porque aprender em público é também uma forma de generosidade.
...
O Zen ensina que o principiante carrega em si algo que o especialista perdeu: a abertura total para o que ainda não sabe.

Este projeto foi construído com mente de principiante.

E convida você a fazer o mesmo.
